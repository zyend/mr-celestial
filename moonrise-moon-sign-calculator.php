 ...
 * Description: Calculates tropical zodiac signs for the Sun, Moon, Rising/Ascendant, major planets, True North Node, and South Node from birth date, time, and location using Swiss Ephemeris WebAssembly and a local city/timezone/coordinates database.
 * Version: 1.0.7
